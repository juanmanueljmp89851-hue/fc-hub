export async function register() {
  ...
  try {
    ...
    const newCards = [
      {
        eaId: 67338744, name: 'Aaron Wan-Bissaka', commonName: 'Wan-Bissaka',
        ...
        cardType: 'path_to_glory', promo: 'Path to Glory', cardImageId: '107_path_to_glory',
      ...
      {
        eaId: 100672972, name: "Samuel Eto'o", commonName: "Eto'o",
        ...
        cardType: 'icon', promo: 'Greats of the Game', cardImageId: '131_greats_of_the_game_icon',
        skillMoves: 5, weakFoot: 5, foot: 'Right', height: 179, weight: 75,
        workRateAtk: 'High', workRateDef: 'Low',
        releaseDate: new Date('2026-06-15'),
      },
      {
        eaId: 50564843, name: 'Xaver Schlager', commonName: 'Schlager',
      ...
      {
        eaId: 151222147, name: 'Alexia Putellas Segura', commonName: 'Alexia Putellas',
      ...
      },
      {
        ...
        cardType: 'showdown', promo: 'Showdown', cardImageId: '62_fof_showdown',
        skillMoves: 5, weakFoot: 4, foot: 'Right', height: 172, weight: 64,
        workRateAtk: 'High', workRateDef: 'Medium',
        releaseDate: new Date('2026-06-14'),
      },
      {
        eaId: 67370982, name: 'Tino Livramento', commonName: 'Livramento',
      ...
      {
        eaId: 84125917, name: 'Alexis Mac Allister', commonName: 'Mac Allister',
