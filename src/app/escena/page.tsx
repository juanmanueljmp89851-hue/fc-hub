  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold">Escena Competitiva</h1>
          <p className="mt-1 text-foreground/60">
            Torneos y ligas de EA FC en Argentina y Latinoamérica
          </p>
        </div>
        ...
        {leagues.length === 0 ? (
          <Card className="p-8 text-center">
            <p className="text-lg font-medium text-foreground/50">
              Próximamente: seguimiento en vivo de ligas externas
            </p>
            <p className="mt-2 text-sm text-foreground/40">
              IESA Argentina, eLPF, VPG y más
            </p>
          </Card>
        ) : (
        ...
        {/* Known leagues info (always show) */}
        <div className="mt-12">
